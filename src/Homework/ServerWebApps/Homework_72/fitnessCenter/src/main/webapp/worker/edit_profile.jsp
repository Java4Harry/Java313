...
<%--                                    %>--%>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" required name="email" class="form-control" id="email"  value="${workerObj.email}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" required name="password" class="form-control" id="psw"  value="${workerObj.password}">
                            </div>
